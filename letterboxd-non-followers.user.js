...
// ---------- Styles ----------
GM_addStyle(  .lbtool-panel{   position:fixed; top:18px; right:18px; width:380px; max-height:82vh; overflow:hidden;   background:#111; color:#fff; z-index:999999; border-radius:14px; padding:14px;   font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;   box-shadow:0 10px 30px rgba(0,0,0,.45); border:1px solid rgba(255,255,255,.10);   }   .lbtool-title{display:flex; align-items:center; justify-content:space-between; gap:10px;}   .lbtool-title h3{margin:0; font-size:16px; font-weight:800;}   .lbtool-x{   appearance:none; border:0; background:#2a2a2a; color:#fff; border-radius:10px;   padding:6px 10px; cursor:pointer; font-weight:700;   }   .lbtool-kv{   display:grid; grid-template-columns:1fr auto; gap:6px;   font-size:13px; opacity:.95; margin-top:10px;   border-top:1px solid rgba(255,255,255,.08); padding-top:10px;   }   .lbtool-row{display:flex; gap:8px; flex-wrap:wrap; margin:12px 0 10px 0;}   .lbtool-btn{   appearance:none; border:0; border-radius:10px; padding:8px 10px; cursor:pointer;   background:#00c2a8; color:#001; font-weight:800; font-size:13px;   }   .lbtool-btn.secondary{background:#2a2a2a; color:#fff; font-weight:700;}   .lbtool-btn.danger{background:#ff4d4f; color:#fff;}   .lbtool-btn:disabled{opacity:.55; cursor:not-allowed}   .lbtool-log{   white-space:pre-wrap;   font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;   background:#0a0a0a; border-radius:10px; padding:10px;   border:1px solid rgba(255,255,255,.08);   font-size:12px; line-height:1.35;   max-height:200px; overflow:auto;   }   .lbtool-list{   margin-top:10px;   background:#0a0a0a; border-radius:10px; padding:10px;   border:1px solid rgba(255,255,255,.08);   max-height:240px; overflow:auto;   }   .lbtool-item{   display:flex; align-items:center; justify-content:space-between; gap:10px;   padding:8px; background:#111; border-radius:10px; margin-bottom:8px;   }   .lbtool-item:last-child{margin-bottom:0;}   .lbtool-user{   display:flex; flex-direction:column; gap:2px; min-width:0;   }   .lbtool-user a{   color:#00c2a8; text-decoration:none; font-weight:800; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;   }   .lbtool-user small{opacity:.75;}   .lbtool-actions{display:flex; gap:8px; flex-shrink:0;}   .lbtool-fab{   position:fixed; bottom:18px; right:18px; z-index:999999;   background:#111; color:#fff; border:1px solid rgba(255,255,255,.15);   border-radius:999px; padding:10px 12px; cursor:pointer; box-shadow:0 10px 30px rgba(0,0,0,.35);   font-weight:900; font-size:13px;   }   .lbtool-muted{opacity:.75}   .lbtool-footer{   margin-top:10px; font-size:12px; opacity:.75;   border-top:1px solid rgba(255,255,255,.08); padding-top:10px;   }  );
...
panel.innerHTML = `
  ...
  </div>      <div class="lbtool-log" id="lbtool-log">Listo. Tocá RUN.</div>      <div class="lbtool-list" id="lbtool-list"></div>      <div class="lbtool-footer">    
...
if (!ok) {
alert('No pude descargar el CSV. Igual lo dejé en window.LB_CSV para copiar desde consola.');
window.LB_CSV = csv;
}
};
